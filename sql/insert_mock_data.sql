...
insert into pharmacy_order_item(order_item_id, order_id, item_id, quantity) values(2, 1, 2, 5);
insert into pharmacy_order_item(order_item_id, order_id, item_id, quantity) values(3, 2, 1, 6);
